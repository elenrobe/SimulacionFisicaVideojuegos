...
UniformParticleGenerator::UniformParticleGenerator(Vector3 pos, Vector3 vel, double genProb, Particle* model, Vector3 posWidth, Vector3 velWidth) : ParticleGenerator()
{
    _name = "Uniforme";
    _mean_pos = pos;
    _mean_vel = vel;

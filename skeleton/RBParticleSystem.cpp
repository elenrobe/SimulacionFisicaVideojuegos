...
RBParticleSystem::RBParticleSystem(physx::PxPhysics* gPhysics, physx::PxScene* gScene)
{
	...
	addWind();
	physx::PxShape* shape = CreateShape(physx::PxBoxGeometry(3, 3, 3));
	physx::PxShape* floor = CreateShape(physx::PxBoxGeometry(100, 1, 100));
	RBParticle* p = new RBParticle({ 0,50,0 }, { 0,0,0 }, { 0,0,0 }, 0.998, 600, { 0,0,255,1 }, 5, gPhysics, gScene, shape, false, 9);
